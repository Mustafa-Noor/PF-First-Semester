...
int PayBill(int totalM[], int totalW[], int quantityM[], int quantityW[], int priceM[], int priceW[], int availableM[], int availableW[], int menq, int womenq, bool &delArea, bool &deliveryop, bool &billpaid, int cardindex, int quantforMen[][30], int quantforWomen[][30]);
        ...
        else if(role1=="Customer")
        {
            ...
            while(true)
            {
                ...
                else if(customerchoice==7)
                {
                    ...
                    int go=PayBill(totalM, totalW, quantityM, quantityW, priceM, priceW, availableM, availableW, menq, womenq, delArea, deliveryop, billpaid, cardindex, quantforMen, quantforWomen);
                    if(go!=0)
                    {
                        restrictGo(go);
                    }
