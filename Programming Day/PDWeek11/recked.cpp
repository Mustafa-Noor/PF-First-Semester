...
string signinMenu(string username[], string password[], string role[], int &cardindex, int range, int idx, int &reviewindex);
...
string customer[range];
    ...
    {
        clearScreen();
        string role1=signinMenu(username, password, role, cardindex, range, idx, reviewindex);
        if(role1=="Employee")
        {
            int employeechoice;
            int choose;
