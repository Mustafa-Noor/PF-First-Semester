...
int bill(string arrM[], string arrW[], int totalM[], int totalW[], int priceM[], int priceW[], int quantityM[], int quantityW[], int menq, int womenq, int cardindex, int finalTotal[], string delivery[], string userArea[], bool deliveryop, bool delArea, int cusCount);
...
string billRem1(bool deliveryop, string delivery[], int cardindex, int cusCount);
string billRem2(bool delArea, string delivery[], int cardindex, int cusCount);
        ...
        else if(role1=="Customer")
        {
            ...
            while(true)
            {
                ...
                else if(customerchoice==5)
                {
                    ...
                    int go=bill(arrM, arrW, totalM, totalW, priceM, priceW, quantityM, quantityW, menq, womenq, cardindex, finalTotal, delivery, userArea, deliveryop, delArea, cusCount);
                    if(go!=0)
                    {
                        restrictGo(go);
                    }
...
string billRem1(bool deliveryop, string delivery[], int cardindex, int cusCount)
{
    ...
    if(deliveryop==1)
    {
    part1="Your Payment Method: " + (delivery[cusCount]);
    }
    else
    {
...
string billRem2(bool delArea, string userArea[], int cardindex, int cusCount)
{
    string part2;
    if(delArea==1)
    {
    part2="Your delivery Address: " + userArea[cusCount];
    }
    else
    {
...
int bill(string arrM[], string arrW[], int totalM[], int totalW[], int priceM[], int priceW[], int quantityM[], int quantityW[], int menq, int womenq, int cardindex, int finalTotal[], string delivery[], string userArea[], bool deliveryop, bool delArea, int cusCount)
{
    ...
    cout << billRem1(deliveryop, delivery, cardindex, cusCount) << endl;
    cout << billRem2(delArea, userArea, cardindex, cusCount) << endl;
...
int showCustomersList(int cusCount, int cardindex, string userArea[], string delivery[], string customer[], int &counter)
{
    for(int idx=0; idx<=cusCount; idx++)
        {
            if(userArea[idx+1]!="" && delivery[idx+1]!="")
            {
            cout << left << setw(12) <<to_string(counter)+". " << setw(20) <<  customer[idx] << setw(20) << userArea[idx+1] << setw(20)<< delivery[idx+1]<< endl;
            }
            else if(userArea[idx+1]!=""  && delivery[idx+1]=="")
            {
            cout << left << setw(12) <<to_string(counter)+". " << setw(20) <<  customer[idx] << setw(20) << userArea[idx+1] << setw(20)<< "Not Selected"<< endl;
            }
            else if(userArea[idx+1]=="" && delivery[idx+1]!="")
            {
            cout << left << setw(12) <<to_string(counter)+". " << setw(20) <<  customer[idx] << setw(20) << "Not Selected" << setw(20)<< delivery[idx+1]<< endl;   
            }
            else 
            {
